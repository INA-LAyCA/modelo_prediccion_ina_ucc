...
import './AboutPage.css'; // Crearemos este archivo de CSS a continuación

// Componente para un ícono simple (usando SVGs inline para no necesitar librerías)
const Icon = ({ children }) => (
  <div className="icon-container">{children}</div>
);

// Íconos SVG para cada sección
const ModelIcon = () => (
